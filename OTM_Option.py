...
def option_spread():
    ...
    #strikes and prices
    call_strike, call_price, call_volume = opt_OTM(ticker, date, "call")
    put_strike, put_price, put_volume = opt_OTM(ticker, date, "put")
